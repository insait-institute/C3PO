...
Qwen2.5-Math 7B fine-tuned with **B3PO** (Bayesian Perturbed Parameter Policy Optimization), from the
paper **"Parameter Exploration for RLVR via Variational Learning"**.
