...
Olmo-3 7B fine-tuned with **C3PO**, from the paper **"Parameter Exploration for RLVR via Variational
Learning"**.
...
model = AutoModelForCausalLM.from_pretrained("BayesRL/Olmo3-C3PO-7B")
tok = AutoTokenizer.from_pretrained("BayesRL/Olmo3-C3PO-7B")
```
